...
c){function d(b,c,f){var g=Object.keys(b).filter(function(a){return r(b[a])||m(b[a])});void 0===b[a][c]&&(b[a][c]=[]);b[a][c].push(f);for(var h=0,l=g.length;h<l;h++)d(g[h],c,f)}d(this,b,c);return this}}function t(a){return function(b,c){function d(b,c,f){var g=Object.keys(b).filter(function(a){return r(b[a])||m(b[a])}),h=0,l=b[a][c].length;a:for(;h<l;h++)if(b[a][c][h].toString()===f.toString()){b[a][c].splice(h,1);break a}h=0;for(l=g.length;h<l;h++)d(g[h],c,f)}d(this,b,c);return this}}function f(a){"string"===
