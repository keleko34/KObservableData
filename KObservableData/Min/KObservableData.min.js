...
a.key.split(".");if(1===b.length&&"*"!==a.key)return a.preventDefault(),!1;if("*"!==a.key)w(a.event.local,b.slice(0,b.length-1).join("."))[a.type](b[b.length-1],a.args[1]);else a.event.listener.indexOf("update")?a.event.local.addChildDataUpdateListener("*",a.args[1]):a.event.local.addChildDataListener("*",a.args[1])}function d(a){void 0===a.parseData&&a.prototype("parseData",n);void 0===a.isArray&&a.prototype("isArray",m);void 0===a.isObject&&a.prototype("isObject",r);void 0===a.isObservable&&a.prototype("isObservable",
x);void 0===a.updateName&&a.prototype("updateName",f);void 0===a.getScopeByScopeString&&a.prototype("getScopeByScopeString",w);void 0===a.addChildDataListener&&a.prototype("addChildDataListener",B("__kbparentlisteners"));void 0===a.removeChildDataListener&&a.prototype("removeChildDataListener",t("__kbparentlisteners"));void 0===a.addChildDataUpdateListener&&a.prototype("addChildDataUpdateListener",B("__kbparentupdatelisteners"));void 0===a.removeChildDataUpdateListener&&a.prototype("removeChildDataUpdateListener",
t("__kbparentupdatelisteners"));return a.addActionListener("add",y).addActionListener("set",g).addActionListener("addDataListener",A).addActionListener("addDataUpdateListener",A).addActionListener("addDataCreateListener",A).addActionListener("addDataRemoveListener",A).addActionListener("removeDataListener",A).addActionListener("removeDataUpdateListener",A).addActionListener("removeDataCreateListener",A).addActionListener("removeDataRemoveListener",A)}function B(a){return function(b,c){function d(b,
c,f){var g=Object.keys(b).filter(function(a){return r(b[a])||m(b[a])});void 0===b[a][c]&&(b[a][c]=[]);b[a][c].push(f);for(var h=0;h<g;h++)d(g[h],c,f)}d(this,b,c);return this}}function t(a){return function(b,c){function d(b,c,f){var g=Object.keys(b).filter(function(a){return r(b[a])||m(b[a])}),h=0,l=b[a][c].length;a:for(;h<l;h++)if(b[a][c][h].toString()===f.toString()){b[a][c].splice(h,1);break a}for(h=0;h<g;h++)d(g[h],c,f)}d(this,b,c);return this}}function f(a){"string"===typeof a&&(q.name=a);return this}
function y(a){if((r(a.args[1])||m(a.args[1]))&&!x(a.args[1])){a.preventDefault();var b=a.event.local,c=b.__kbscopeString+(0!==b.__kbscopeString.length?".":"")+a.key,c=(r(a.args[1])?v:D)(b.__kbname,b,c);b.add(a.key,c);d(b[a.key]).parseData(a.args[1])}}function g(a){if((r(a.args[1])||m(a.args[1]))&&!x(a.args[1])){a.preventDefault();var b=a.event.local,c=b.__kbscopeString+(0!==b.__kbscopeString.length?".":"")+a.key,c=(r(a.args[1])?v:D)(b.__kbname,b,c);b.set(a.key,c);d(b[a.key]).parseData(a.args[1])}}
function n(a){for(var b=0,c=Object.keys(a),d=c.length;b<d;b++)this.set(c[b],a[c[b]]);return this}var q={name:E};_data=("string"===typeof l&&"array"===l.toLowercase()?D:v)(q.name,void 0,"").addPointer(q,"name","__kbname");d(_data);return _data}}(G,H);window.define&&window.require?define([],function(){return F}):window.module&&(module.exports=F);return F}();
